...
{
////////////////////////////////////////////////////////////
/// \brief UIWindow that can serve as a target for 2D drawing
///
////////////////////////////////////////////////////////////
...
public:
    ...
    /// \param style    %UIWindow style, a bitwise OR combination of sf::Style enumerators
    ...
    ///                 Windows, \a %UIWindow on Linux/FreeBSD, \a NSWindow on OS X)
    /// \param settings Additional settings for the underlying OpenGL context
    ///
    ////////////////////////////////////////////////////////////
    ...
    ///
    /// \deprecated
    /// Use a sf::Texture and its sf::Texture::update(const UIWindow&)
...
///
/// sf::RenderWindow is derived from sf::UIWindow, thus it inherits
/// all its features: events, window management, OpenGL rendering,
/// etc. See the documentation of sf::UIWindow for a more complete
...
///    window.clear();
///
///    // Draw some graphical m_entities
///    window.draw(sprite);
///    window.draw(circle);
///    window.draw(text);
///
...
/// \endcode
///
/// Like sf::UIWindow, sf::RenderWindow is still able to render direct
...
/// \endcode
///
/// \see sf::UIWindow, sf::RenderTarget, sf::RenderTexture, sf::GUI
///
////////////////////////////////////////////////////////////
