...
public:
    ...
    /// used when drawing SFML m_entities. It must be used only if you
...
/// to apply real-time operations to the rendered m_entities.
///
...
///     sf::Texture::update(UIWindow&) to copy its contents to a texture
