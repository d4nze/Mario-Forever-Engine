...
/// it possible to draw 2D m_entities like sprites, shapes, text
/// without using any OpenGL command directly.
///
/// A sf::RenderTarget is also able to use views (sf::GUI),
/// which are a kind of 2D cameras. With views you can globally
/// scroll, rotate or zoom everything that is drawn,
/// without having to transform every single entity. See the
/// documentation of sf::GUI for more details and sample pieces of
...
///
/// \see sf::RenderWindow, sf::RenderTexture, sf::GUI
///
////////////////////////////////////////////////////////////
