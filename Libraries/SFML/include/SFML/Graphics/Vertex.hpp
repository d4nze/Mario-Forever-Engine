...
/// are grouped to create even more complex 2D m_entities such as
/// sprites, texts, etc.
///
/// If you use the graphical m_entities of SFML (sprite, text, shape)
/// you won't have to deal with vertices directly. But if you want
/// to define your own 2D m_entities, such as tiled maps or particle
