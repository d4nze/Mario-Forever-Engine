...
////////////////////////////////////////////////////////////
/// \brief UIWindow that serves as a target for OpenGL rendering
///
////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// After calling this function, the sf::UIWindow instance remains
...
/// \ingroup window
///
/// sf::UIWindow is the main class of the UIWindow module. It defines
/// an OS window that is able to receive an OpenGL rendering.
///
/// A sf::UIWindow can create its own new window, or be embedded into
...
///
/// The sf::UIWindow class provides a simple interface for manipulating
...
/// sf::UIWindow window(sf::VideoMode(800, 600), "SFML window");
///
