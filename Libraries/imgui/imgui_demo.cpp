...
// [SECTION] Helpers
// [SECTION] Demo UIWindow / ShowDemoWindow()
// - ShowDemoWindow()
...
// [SECTION] About UIWindow / ShowAboutWindow()
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    IMGUI_DEMO_MARKER("UIWindow options");
    if (ImGui::CollapsingHeader("UIWindow options"))
    {
...
static void ShowDemoWindowWidgets()
{
    ...
    IMGUI_DEMO_MARKER("Widgets/Querying UIWindow Status (Focused,Hovered etc.)");
    if (ImGui::TreeNode("Querying UIWindow Status (Focused/Hovered etc.)"))
    {
...
static void ShowDemoWindowPopups()
{
    ...
    {
        HelpMarker("\"Context\" functions are simple helpers to associate a Popup to a given Item or UIWindow identifier.");
...
static void ShowExampleAppAutoResize(bool* p_open)
{
    ...
    ImGui::TextUnformatted(
        "UIWindow will resize every-frame to the size of its content.\n"
...
static void ShowExampleAppConstrainedResize(bool* p_open)
{
    ...
    if (window_open)
    {
        ...
        else
        {
            ...
            ImGui::Checkbox("UIWindow padding", &window_padding);
...
//-----------------------------------------------------------------------------
// [SECTION] Example App: Manipulating UIWindow Titles / ShowExampleAppWindowTitles()
//-----------------------------------------------------------------------------
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    ImGui::PushItemWidth(ImGui::GetFontSize() * 12);
    ImGui::Combo("Output", (int*)&opt_target, "None\0TabBar+Tabs\0DockSpace+UIWindow\0");
    ImGui::PopItemWidth();
